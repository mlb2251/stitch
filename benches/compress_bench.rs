...
pub fn compression_benchmark(c: &mut Criterion) {
    ...
    group.bench_function("logo/train_200.json -t4 -i3 -a2", |b| b.iter(|| compression(black_box(&programs_logo_train_200), black_box(&cfg_arity2), black_box(3))));
    group.bench_function("cogsci/train_200.json -t4 -i3 -a3", |b| b.iter(|| compression(black_box(&programs_logo_train_200), black_box(&cfg_arity3), black_box(3))));
    group.bench_function("cogsci/nuts-bolts.json -t4 -i3 -a2", |b| b.iter(|| compression(black_box(&programs_nuts_bolts), black_box(&cfg_arity2), black_box(3))));
    group.bench_function("cogsci/nuts-bolts.json -t4 -i3 -a3", |b| b.iter(|| compression(black_box(&programs_nuts_bolts), black_box(&cfg_arity3), black_box(3))));
    group.bench_function("cogsci/dials.json -t4 -i1 -a2", |b| b.iter(|| compression(black_box(&programs_dials), black_box(&cfg_arity2), black_box(1))));
    group.bench_function("cogsci/furniture.json -t4 -i1 -a2", |b| b.iter(|| compression(black_box(&programs_furniture), black_box(&cfg_arity2), black_box(1))));
    group.finish();

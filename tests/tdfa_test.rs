...
fn test_basic() {
    ...
    assert_tdfa(json,  "T".to_string(),  "E".to_string(), ("listV".to_string(), "V".to_string()), "(Assign x (list 3 4 5))", expected);
}
...
fn test_non_eta_long() {
    ...
    assert_tdfa(json,  "T".to_string(),  "E".to_string(), ("listV".to_string(), "V".to_string()), "(Assign (vars x y z) (list 3 4 5))", expected);
}
...
fn test_non_eta_long_with_args() {
    ...
    assert_tdfa(json,  "T".to_string(),  "E".to_string(), ("listV".to_string(), "V".to_string()), "(Assign (fn_1 x y z) (list 3 4 5))", expected);
}

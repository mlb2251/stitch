...
fn symbols_basic() {
    ...
    compare_out_jsons("data/python/import-and-number-in-same-spot.json", "data/expected_outputs/import-and-number-in-same-spot.json", &("-i3 -a0 ".to_owned() + &python_args()), InputFormat::ProgramsList);
}
